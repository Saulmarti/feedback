...
class FeedbackWidgetState extends State<FeedbackWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData theme = ThemeData(
      ...
      cardColor: feedbackThemeData.cardColor ?? feedbackThemeData.feedbackSheetColor,
      colorScheme: feedbackThemeData.colorScheme,
      primaryColor: feedbackThemeData.primaryColor,
      primaryColorLight: feedbackThemeData.primaryColorLight,
      primaryColorDark: feedbackThemeData.primaryColorDark,
      scaffoldBackgroundColor: feedbackThemeData.scaffoldBackgroundColor,
      canvasColor: feedbackThemeData.canvasColor,
      dividerColor: feedbackThemeData.dividerColor,
      focusColor: feedbackThemeData.focusColor,
      hoverColor: feedbackThemeData.hoverColor,
      highlightColor: feedbackThemeData.highlightColor,
      splashColor: feedbackThemeData.splashColor,
      unselectedWidgetColor: feedbackThemeData.unselectedWidgetColor,
      disabledColor: feedbackThemeData.disabledColor,
      buttonTheme: feedbackThemeData.buttonTheme,
      toggleButtonsTheme: feedbackThemeData.toggleButtonsTheme,
      appBarTheme: feedbackThemeData.appBarTheme,
      textTheme: feedbackThemeData.textTheme,
      primaryTextTheme: feedbackThemeData.primaryTextTheme,
      inputDecorationTheme: feedbackThemeData.inputDecorationTheme,
      iconTheme: feedbackThemeData.iconTheme,
      primaryIconTheme: feedbackThemeData.primaryIconTheme,
      sliderTheme: feedbackThemeData.sliderTheme,
      tabBarTheme: feedbackThemeData.tabBarTheme,
      tooltipTheme: feedbackThemeData.tooltipTheme,
      cardTheme: feedbackThemeData.cardTheme,
      chipTheme: feedbackThemeData.chipTheme,
      materialTapTargetSize: feedbackThemeData.materialTapTargetSize,
      pageTransitionsTheme: feedbackThemeData.pageTransitionsTheme,
      bottomAppBarTheme: feedbackThemeData.bottomAppBarTheme,
      dialogTheme: feedbackThemeData.dialogTheme,
      floatingActionButtonTheme: feedbackThemeData.floatingActionButtonTheme,
      navigationBarTheme: feedbackThemeData.navigationBarTheme,
      navigationRailTheme: feedbackThemeData.navigationRailTheme,
      snackBarTheme: feedbackThemeData.snackBarTheme,
      bottomSheetTheme: feedbackThemeData.bottomSheetTheme,
      popupMenuTheme: feedbackThemeData.popupMenuTheme,
      bannerTheme: feedbackThemeData.bannerTheme,
      dividerTheme: feedbackThemeData.dividerTheme,
      listTileTheme: feedbackThemeData.listTileTheme,
      badgeTheme: feedbackThemeData.badgeTheme,
      bottomNavigationBarTheme: feedbackThemeData.bottomNavigationBarTheme,
      checkboxTheme: feedbackThemeData.checkboxTheme,
      radioTheme: feedbackThemeData.radioTheme,
      switchTheme: feedbackThemeData.switchTheme,
      progressIndicatorTheme: feedbackThemeData.progressIndicatorTheme,
      drawerTheme: feedbackThemeData.drawerTheme,
      dataTableTheme: feedbackThemeData.dataTableTheme,
      dropdownMenuTheme: feedbackThemeData.dropdownMenuTheme,
      searchBarTheme: feedbackThemeData.searchBarTheme,
      searchViewTheme: feedbackThemeData.searchViewTheme,
      segmentedButtonTheme: feedbackThemeData.segmentedButtonTheme,
      useMaterial3: feedbackThemeData.useMaterial3,
      visualDensity: feedbackThemeData.visualDensity,
    );
